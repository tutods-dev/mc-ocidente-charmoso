...
import { o as E, p as Ee, q as bc, V as Ve, r as lt$1, s as x, F as Fc, t as Dc, u as Oc, v as Nc, w as jc, B as Hc, C as Wc, G as Vc, I as Bc } from '../runtime.mjs';
...
class lt {
  constructor(n, a) {
    this.listeners = /* @__PURE__ */ new Set(), this._batching = false, this._flushing = 0, this.subscribe = (e) => {
      var t, s;
      this.listeners.add(e);
      const r = (s = (t = this.options) == null ? void 0 : t.onSubscribe) == null ? void 0 : s.call(t, e, this);
      return () => {
        this.listeners.delete(e), r == null ? void 0 : r();
      };
    }, this.setState = (e) => {
      var t, s, r;
      const o = this.state;
      this.state = (t = this.options) != null && t.updateFn ? this.options.updateFn(o)(e) : e(o), (r = (s = this.options) == null ? void 0 : s.onUpdate) == null || r.call(s), this._flush();
    }, this._flush = () => {
      if (this._batching)
        return;
      ...
      if (this._batching)
        return e();
      this._batching = true, e(), this._batching = false, this._flush();
    }, this.state = n, this.options = a;
  }
}
function H(i, n) {
...
const Ct = /^(\d*)$/gm, Tt = /\.(\d*)\./gm, Zt = /^(\d*)\./gm, Bt = /\.(\d*$)/gm, qt = /\.{2,}/gm, I = "__int__", C = `${I}$1`;
function z(i) {
  if (typeof i != "string")
    throw new Error("Path must be a string.");
  return i.replaceAll("[", ".").replaceAll("]", "").replace(Ct, C).replace(Tt, `.${C}.`).replace(Zt, `${C}.`).replace(Bt, `.${C}`).replace(qt, ".").split(".").map((n) => n.indexOf(I) === 0 ? parseInt(n.substring(I.length), 10) : n);
}
function kt(i) {
  return !(Array.isArray(i) && i.length === 0);
}
function O(i, n) {
  const { asyncDebounceMs: a } = n, { onChangeAsync: e, onBlurAsync: t, onSubmitAsync: s, onBlurAsyncDebounceMs: r, onChangeAsyncDebounceMs: o } = n.validators || {}, d = a != null ? a : 0, u = { cause: "change", validate: e, debounceMs: o != null ? o : d }, l = { cause: "blur", validate: t, debounceMs: r != null ? r : d }, p = { cause: "submit", validate: s, debounceMs: 0 }, c = (f) => ({ ...f, debounceMs: 0 });
  switch (i) {
    case "submit":
      return [c(u), c(l), p];
    case "blur":
...
function L(i, n) {
  const { onChange: a, onBlur: e, onSubmit: t } = n.validators || {}, s = { cause: "change", validate: a }, r = { cause: "blur", validate: e }, o = { cause: "submit", validate: t }, d = { cause: "server", validate: () => {
  } };
  switch (i) {
    case "submit":
      return [s, r, o, d];
...
function q(i) {
  ...
  return { values: (_a2 = i.values) != null ? _a2 : {}, errors: (_b2 = i.errors) != null ? _b2 : [], errorMap: (_c2 = i.errorMap) != null ? _c2 : {}, fieldMeta: (_d2 = i.fieldMeta) != null ? _d2 : {}, canSubmit: (_e = i.canSubmit) != null ? _e : true, isFieldsValid: (_f = i.isFieldsValid) != null ? _f : false, isFieldsValidating: (_g = i.isFieldsValidating) != null ? _g : false, isFormValid: (_h = i.isFormValid) != null ? _h : false, isFormValidating: (_i = i.isFormValidating) != null ? _i : false, isSubmitted: (_j = i.isSubmitted) != null ? _j : false, isSubmitting: (_k = i.isSubmitting) != null ? _k : false, isTouched: (_l = i.isTouched) != null ? _l : false, isBlurred: (_m = i.isBlurred) != null ? _m : false, isPristine: (_n = i.isPristine) != null ? _n : true, isDirty: (_o = i.isDirty) != null ? _o : false, isValid: (_p = i.isValid) != null ? _p : false, isValidating: (_q = i.isValidating) != null ? _q : false, submissionAttempts: (_r = i.submissionAttempts) != null ? _r : 0, validationMetaMap: (_s = i.validationMetaMap) != null ? _s : { onChange: void 0, onBlur: void 0, onSubmit: void 0, onMount: void 0, onServer: void 0 } };
}
class It {
  constructor(n) {
    var _a2;
    ...
    this.options = {}, this.fieldInfo = {}, this.prevTransformArray = [], this.mount = () => {
      ...
      if (!e)
        return;
      const t = this.runValidator({ validate: e, value: { value: this.state.values, formApi: this }, type: "validate" });
      ...
      this.options = e, this.store.batch(() => {
        const s = e.defaultValues && e.defaultValues !== t.defaultValues && !this.state.isTouched, r = e.defaultState !== t.defaultState && !this.state.isTouched;
        this.store.setState(() => q(Object.assign({}, this.state, r ? e.defaultState : {}, s ? { values: e.defaultValues } : {})));
      });
    }, this.reset = () => {
      const { fieldMeta: e } = this.state, t = this.resetFieldMeta(e);
      this.store.setState(() => {
        var _a3;
        var s;
        return q({ ...this.options.defaultState, values: (_a3 = this.options.defaultValues) != null ? _a3 : (s = this.options.defaultState) == null ? void 0 : s.values, fieldMeta: t });
      });
      ...
      return this.store.batch(() => {
        Object.values(this.fieldInfo).forEach((r) => {
          if (!r.instance)
            return;
          const o = r.instance;
          t.push(Promise.resolve().then(() => o.validate(e))), r.instance.state.meta.isTouched || r.instance.setMeta((d) => ({ ...d, isTouched: true })), r.instance.state.meta.isBlurred || r.instance.setMeta((d) => ({ ...d, isBlurred: true }));
        });
      }), (await Promise.all(t)).flat();
    }, this.validateArrayFieldsStartingFrom = async (e, t, s) => {
      const r = this.getFieldValue(e), o = Array.isArray(r) ? Math.max(r.length - 1, 0) : null, d = [`${e}[${t}]`];
      for (let c = t + 1; c <= (o != null ? o : 0); c++)
        d.push(`${e}[${c}]`);
      const u = Object.keys(this.fieldInfo).filter((c) => d.some((f) => c.startsWith(f))), l = [];
      return this.store.batch(() => {
        u.forEach((c) => {
      ...
      return r ? (r.state.meta.isTouched || r.setMeta((o) => ({ ...o, isTouched: true })), r.state.meta.isBlurred || r.setMeta((o) => ({ ...o, isBlurred: true })), r.validate(t)) : [];
    }, this.validateSync = (e) => {
      ...
      this.store.batch(() => {
        for (const d of t) {
          if (!d.validate)
            continue;
          const u = this.runValidator({ validate: d.validate, value: { value: this.state.values, formApi: this }, type: "validate" }), { formError: l, fieldErrors: p } = U(u), c = T(d.cause);
          if (p)
            for (const [f, v] of Object.entries(p)) {
              const A = { ...r[f] || {}, [c]: v };
              r[f] = A;
              const b = this.getFieldMeta(f);
              b && b.errorMap[c] !== v && this.setFieldMeta(f, (M) => ({ ...M, errorMap: { ...M.errorMap, [c]: v } }));
            }
          this.state.errorMap[c] !== l && this.store.setState((f) => ({ ...f, errorMap: { ...f.errorMap, [c]: l } })), (l || p) && (s = true);
        }
      });
      const o = T("submit");
      return this.state.errorMap[o] && e !== "submit" && !s && this.store.setState((d) => ({ ...d, errorMap: { ...d.errorMap, [o]: void 0 } })), { hasErrored: s, fieldsErrorMap: r };
    }, this.validateAsync = async (e) => {
      const t = O(e, this.options);
      this.state.isFormValidating || this.store.setState((u) => ({ ...u, isFormValidating: true }));
      const s = [];
      let r;
      for (const u of t) {
        if (!u.validate)
          continue;
        const l = T(u.cause), p = this.state.validationMetaMap[l];
        p == null ? void 0 : p.lastAbortController.abort();
        const c = new AbortController();
        this.state.validationMetaMap[l] = { lastAbortController: c }, s.push(new Promise(async (f) => {
          let v;
          try {
            v = await new Promise((M, m) => {
              setTimeout(async () => {
                if (c.signal.aborted)
                  return M(void 0);
                try {
                  M(await this.runValidator({ validate: u.validate, value: { value: this.state.values, formApi: this, signal: c.signal }, type: "validateAsync" }));
                } catch (S) {
                  m(S);
                }
              }, u.debounceMs);
          ...
          if (r)
            for (const [M, m] of Object.entries(r)) {
              ...
              S && S.errorMap[b] !== m && this.setFieldMeta(M, (x) => ({ ...x, errorMap: { ...x.errorMap, [b]: m } }));
            }
          this.store.setState((M) => ({ ...M, errorMap: { ...M.errorMap, [b]: y } })), f(r ? { fieldErrors: r, errorMapKey: b } : void 0);
        }));
      }
      let o = [];
      const d = {};
      if (s.length) {
        ...
        for (const u of o)
          if (u == null ? void 0 : u.fieldErrors) {
      ...
      return this.store.setState((u) => ({ ...u, isFormValidating: false })), d;
    }, this.validate = (e) => {
      const { hasErrored: t, fieldsErrorMap: s } = this.validateSync(e);
      return t && !this.options.asyncAlways ? s : this.validateAsync(e);
    }, this.handleSubmit = async () => {
      var e, t, s, r, o, d;
      if (this.store.setState((l) => ({ ...l, isSubmitted: false, submissionAttempts: l.submissionAttempts + 1 })), !this.state.canSubmit)
        return;
      this.store.setState((l) => ({ ...l, isSubmitting: true }));
      const u = () => {
        this.store.setState((l) => ({ ...l, isSubmitting: false }));
      };
      if (await this.validateAllFields("submit"), !this.state.isFieldsValid) {
        u(), (t = (e = this.options).onSubmitInvalid) == null || t.call(e, { value: this.state.values, formApi: this });
        return;
      }
      if (await this.validate("submit"), !this.state.isValid) {
        u(), (r = (s = this.options).onSubmitInvalid) == null || r.call(s, { value: this.state.values, formApi: this });
        return;
      }
      try {
        await ((d = (o = this.options).onSubmit) == null ? void 0 : d.call(o, { value: this.state.values, formApi: this })), this.store.batch(() => {
          this.store.setState((l) => ({ ...l, isSubmitted: true })), u();
        });
      } catch (l) {
        throw u(), l;
      }
    }, this.getFieldValue = (e) => ct(this.state.values, e), this.getFieldMeta = (e) => this.state.fieldMeta[e], this.getFieldInfo = (e) => {
      var t;
      return (t = this.fieldInfo)[e] || (t[e] = { instance: null, validationMetaMap: { onChange: void 0, onBlur: void 0, onSubmit: void 0, onMount: void 0, onServer: void 0 } });
    }, this.setFieldMeta = (e, t) => {
      this.store.setState((s) => ({ ...s, fieldMeta: { ...s.fieldMeta, [e]: H(t, s.fieldMeta[e]) } }));
    }, this.resetFieldMeta = (e) => Object.keys(e).reduce((t, s) => {
      const r = s;
      return t[r] = { isValidating: false, isTouched: false, isBlurred: false, isDirty: false, isPristine: true, errors: [], errorMap: {} }, t;
    }, {}), this.setFieldValue = (e, t, s) => {
      var _a3;
      const r = (_a3 = s == null ? void 0 : s.dontUpdateMeta) != null ? _a3 : false;
      this.store.batch(() => {
        r || this.setFieldMeta(e, (o) => ({ ...o, isTouched: true, isBlurred: true, isDirty: true })), this.store.setState((o) => ({ ...o, values: B(o.values, e, t) }));
      });
    }, this.deleteField = (e) => {
      ...
      this.setFieldValue(e, (o) => o.map((d, u) => u === t ? s : d), r), await this.validateField(e, "change"), await this.validateArrayFieldsStartingFrom(e, t, "change");
    }, this.removeFieldValue = async (e, t, s) => {
      const r = this.getFieldValue(e), o = Array.isArray(r) ? Math.max(r.length - 1, 0) : null;
      if (this.setFieldValue(e, (d) => d.filter((u, l) => l !== t), s), o !== null) {
        const d = `${e}[${o}]`;
        Object.keys(this.fieldInfo).filter((l) => l.startsWith(d)).forEach((l) => this.deleteField(l));
      }
      await this.validateField(e, "change"), await this.validateArrayFieldsStartingFrom(e, t, "change");
    }, this.swapFieldValues = (e, t, s, r) => {
      this.setFieldValue(e, (o) => {
        const d = o[t], u = o[s];
        return B(B(o, `${t}`, u), `${s}`, d);
      }, r), this.validateField(e, "change"), this.validateField(`${e}[${t}]`, "change"), this.validateField(`${e}[${s}]`, "change");
    }, this.moveFieldValues = (e, t, s, r) => {
      this.setFieldValue(e, (o) => (o.splice(s, 0, o.splice(t, 1)[0]), o), r), this.validateField(e, "change"), this.validateField(`${e}[${t}]`, "change"), this.validateField(`${e}[${s}]`, "change");
    }, this.store = new lt(q({ ...n == null ? void 0 : n.defaultState, values: (_a2 = n == null ? void 0 : n.defaultValues) != null ? _a2 : (a = n == null ? void 0 : n.defaultState) == null ? void 0 : a.values, isFormValid: true }), { onUpdate: () => {
      var _a3;
      var e, t;
      let { state: s } = this.store;
      const r = Object.values(s.fieldMeta), o = r.some((m) => m == null ? void 0 : m.isValidating), d = !r.some((m) => (m == null ? void 0 : m.errorMap) && kt(Object.values(m.errorMap).filter(Boolean))), u = r.some((m) => m == null ? void 0 : m.isTouched), l = r.some((m) => m == null ? void 0 : m.isBlurred), p = r.some((m) => m == null ? void 0 : m.isDirty), c = !p, f = o || s.isFormValidating;
      s.errors = Object.values(s.errorMap).filter((m) => m !== void 0);
      const v = s.errors.length === 0, y = d && v, A = s.submissionAttempts === 0 && !u || !f && !s.isSubmitting && y;
      s = { ...s, isFieldsValidating: o, isFieldsValid: d, isFormValid: v, isValid: y, canSubmit: A, isTouched: u, isBlurred: l, isPristine: c, isDirty: p }, this.state = s, this.store.state = this.state;
      const b = (_a3 = (e = this.options.transform) == null ? void 0 : e.deps) != null ? _a3 : [];
      (b.length !== this.prevTransformArray.length || b.some((m, S) => m !== this.prevTransformArray[S])) && ((t = this.options.transform) == null || t.fn(this), this.store.state = this.state, this.prevTransformArray = b);
    } }), this.state = this.store.state, this.update(n || {});
  }
  runValidator(n) {
...
function U(i) {
  if (i) {
    if (typeof i == "object") {
      const n = U(i.form).formError, a = i.fields;
  ...
  constructor(n) {
    ...
    this.options = {}, this.mount = () => {
      ...
      const e = this.form.store.subscribe(() => {
        this.store.batch(() => {
          const s = this.getValue(), r = this.getMeta();
          s !== this.state.value && this.store.setState((o) => ({ ...o, value: s })), r !== this.state.meta && this.store.setState((o) => ({ ...o, meta: r }));
        });
      });
      this.update(this.options);
      const { onMount: t } = this.options.validators || {};
      if (t) {
        const s = this.runValidator({ validate: t, value: { value: this.state.value, fieldApi: this }, type: "validate" });
        s && this.setMeta((r) => ({ ...r, errorMap: { ...r == null ? void 0 : r.errorMap, onMount: s } }));
      }
      return () => {
        e();
      };
      ...
      if (this.state.value === void 0) {
        ...
        a.defaultValue !== void 0 ? this.setValue(a.defaultValue, { dontUpdateMeta: true }) : e !== void 0 && this.setValue(e, { dontUpdateMeta: true });
      }
      this._getMeta() === void 0 && this.setMeta(this.state.meta), this.options = a;
    }, this.getValue = () => this.form.getFieldValue(this.name), this.setValue = (a, e) => {
      this.form.setFieldValue(this.name, a, e), this.validate("change");
    }, this._getMeta = () => this.form.getFieldMeta(this.name), this.getMeta = () => {
      var _a3;
      return (_a3 = this._getMeta()) != null ? _a3 : { isValidating: false, isTouched: false, isBlurred: false, isDirty: false, isPristine: true, errors: [], errorMap: {}, ...this.options.defaultMeta };
    }, this.setMeta = (a) => this.form.setFieldMeta(this.name, a), this.getInfo = () => this.form.getFieldInfo(this.name), this.pushValue = (a, e) => this.form.pushFieldValue(this.name, a, e), this.insertValue = (a, e, t) => this.form.insertFieldValue(this.name, a, e, t), this.replaceValue = (a, e, t) => this.form.replaceFieldValue(this.name, a, e, t), this.removeValue = (a, e) => this.form.removeFieldValue(this.name, a, e), this.swapValues = (a, e, t) => this.form.swapFieldValues(this.name, a, e, t), this.moveValue = (a, e, t) => this.form.moveFieldValues(this.name, a, e, t), this.getLinkedFields = (a) => {
      const e = Object.values(this.form.fieldInfo), t = [];
      for (const s of e) {
        if (!s.instance)
          continue;
        const { onChangeListenTo: r, onBlurListenTo: o } = s.instance.options.validators || {};
        a === "change" && (r == null ? void 0 : r.includes(this.name)) && t.push(s.instance), a === "blur" && (o == null ? void 0 : o.includes(this.name)) && t.push(s.instance);
      }
      return t;
    }, this.validateSync = (a, e) => {
      const t = L(a, this.options), r = this.getLinkedFields(a).reduce((u, l) => {
      ...
      this.form.store.batch(() => {
        const u = (l, p) => {
          const c = P(p.cause), f = p.validate ? R(l.runValidator({ validate: p.validate, value: { value: l.getValue(), fieldApi: l }, type: "validate" })) : e[c];
          l.state.meta.errorMap[c] !== f && l.setMeta((v) => ({ ...v, errorMap: { ...v.errorMap, [P(p.cause)]: f || e[c] } })), (f || e[c]) && (o = true);
        };
        for (const l of t)
          u(this, l);
        for (const l of r)
      ...
      const d = P("submit");
      return this.state.meta.errorMap[d] && a !== "submit" && !o && this.setMeta((u) => ({ ...u, errorMap: { ...u.errorMap, [d]: void 0 } })), { hasErrored: o };
    }, this.validateAsync = async (a, e) => {
      const t = O(a, this.options), s = await e, r = this.getLinkedFields(a), o = r.reduce((c, f) => {
        const v = O(a, f.options);
        return v.forEach((y) => {
          y.field = f;
        }), c.concat(v);
      }, []);
      this.state.meta.isValidating || this.setMeta((c) => ({ ...c, isValidating: true }));
      for (const c of r)
        c.setMeta((f) => ({ ...f, isValidating: true }));
      const d = [], u = [], l = (c, f, v) => {
        const y = P(f.cause), A = c.getInfo().validationMetaMap[y];
        A == null ? void 0 : A.lastAbortController.abort();
        const b = new AbortController();
        this.getInfo().validationMetaMap[y] = { lastAbortController: b }, v.push(new Promise(async (M) => {
          var m;
          let S;
          try {
            S = await new Promise(($, mt) => {
              setTimeout(async () => {
                if (b.signal.aborted)
                  return $(void 0);
                try {
                  $(await this.runValidator({ validate: f.validate, value: { value: c.getValue(), fieldApi: c, signal: b.signal }, type: "validateAsync" }));
                } catch (pt) {
                  mt(pt);
                }
              }, f.debounceMs);
          ...
          if (b.signal.aborted)
            return M(void 0);
          const x = R(S), ft = (m = s[this.name]) == null ? void 0 : m[y], G = x || ft;
          c.setMeta(($) => ({ ...$, errorMap: { ...$ == null ? void 0 : $.errorMap, [y]: G } })), M(G);
        }));
      };
      for (const c of t)
      ...
      let p = [];
      (d.length || u.length) && (p = await Promise.all(d), await Promise.all(u)), this.setMeta((c) => ({ ...c, isValidating: false }));
      for (const c of r)
        c.setMeta((f) => ({ ...f, isValidating: false }));
      ...
      return r && !this.options.asyncAlways ? ((e = this.getInfo().validationMetaMap[P(a)]) == null || e.lastAbortController.abort(), this.state.meta.errors) : this.validateAsync(a, s);
    }, this.handleChange = (a) => {
      this.setValue(a);
    }, this.handleBlur = () => {
      this.state.meta.isTouched || (this.setMeta((e) => ({ ...e, isTouched: true })), this.validate("change")), this.state.meta.isBlurred || this.setMeta((e) => ({ ...e, isBlurred: true })), this.validate("blur");
    }, this.form = n.form, this.name = n.name, n.defaultValue !== void 0 && this.form.setFieldValue(this.name, n.defaultValue, { dontUpdateMeta: true }), this.store = new lt({ value: this.getValue(), meta: (_a2 = this._getMeta()) != null ? _a2 : { isValidating: false, isTouched: false, isBlurred: false, isDirty: false, isPristine: true, errors: [], errorMap: {}, ...n.defaultMeta } }, { onUpdate: () => {
      const a = this.store.state;
      a.meta.errors = Object.values(a.meta.errorMap).filter((e) => e !== void 0), a.meta.isPristine = !a.meta.isDirty, this.prevState = a, this.state = a;
    } }), this.state = this.store.state, this.prevState = this.state, this.options = n;
  }
  runValidator(n) {
...
function Q(i, n = (a) => a) {
  const [a, e] = createStore({ value: n(i.state) }), t = i.subscribe(() => {
    const s = n(i.state);
    e("value", reconcile(s));
  });
  return onCleanup(() => {
...
function Lt(i) {
  const [n, a] = createSignal(false), e = createMemo(() => [n(), i]), t = i.store.subscribe(() => a((s) => !s));
  return onCleanup(t), () => e()[1];
}
function dt(i) {
  const n = i(), a = new Ot(n), e = a;
  return e.Field = ut, createComputed(() => a.update(i())), onMount(() => onCleanup(a.mount())), Lt(e);
}
function ut(i) {
  const n = dt(() => {
  ...
  return createComponent$1(() => i.children(n), {});
}
function Ut(i) {
  const n = i == null ? void 0 : i(), a = new It(n), e = a;
  return e.Field = (t) => createComponent(ut, mergeProps(t, { form: a })), e.createField = (t) => dt(() => ({ ...t(), form: a })), e.useStore = (t) => Q(a.store, t), e.Subscribe = (t) => H(t.children, Q(a.store, t.selector)), onMount(a.mount), createComputed(() => a.update(i == null ? void 0 : i())), e;
}
...
<h3>Novo Formul\xE1rio de Contacto</h3>

<p>Recebeu um novo formul\xE1rio de contacto de ${a}:</p>
<ul>
<li><strong>Nome:</strong> ${a}</li>
<li><strong>Email:</strong> <a href="mailto:${i}">${i}</a></li>
${e ? `<li><strong>Contacto Telef\xF3nico:</strong> <a href="tel:${e}">${e}</a></li>` : ""}
</ul>
...
<p style="margin-top: 40px;">
    Ao seu dispor,<br />
    <strong>${t}</strong>.
</p>`, ht = createTransport({ host: (_a = process.env.SMTP_HOST) != null ? _a : "", port: (_b = Number(process.env.SMTP_PORT)) != null ? _b : 587, secureConnection: !!process.env.SMTP_SECURE, auth: { user: (_c = process.env.SMTP_EMAIL) != null ? _c : "", pass: (_d = process.env.SMTP_PASSWORD) != null ? _d : "" } });
ht.verify((i, n) => {
  i ? console.error("\u{1F4E5} Email serverw error:", i) : console.info("\u{1F4E4} Email server is ready to send messages!");
});
const Dt = E(Ee(Ht, "c_10313", "$$function0"));
async function Ht(i) {
  try {
    await ht.sendMail({ from: lt$1.email.email, to: lt$1.email.email, subject: "Formul\xE1rio de contacto", html: jt({ email: i.email, message: i.message, name: i.name, phone: i.phone ? i.phone : void 0, title: "Impulsionar" }) });
  } catch {
  }
}
var zt = ["<span", ' class="text-red-500">*</span>'];
function Gt(i) {
  const n = mergeProps$1({ class: "" }, i), [a, e, t] = splitProps(n, ["field", "children", "class", "helpMessage"], ["onChange"]);
  return createComponent(Nc, { get validationState() {
    return a.field.state.meta.errors.length ? "invalid" : "valid";
  }, get onChange() {
    return e.onChange;
  }, class: "flex flex-col gap-1.5", get children() {
    return [createComponent(jc, { get for() {
      var _a2;
      return (_a2 = t.name) != null ? _a2 : t.id;
    }, get children() {
      return [a.children, createComponent(Show, { get when() {
        return t.required;
      }, get children() {
        return ssr(zt, ssrHydrationKey());
      } })];
    } }), createComponent(Hc, mergeProps(t, { get name() {
      var _a2;
      return (_a2 = t.name) != null ? _a2 : t.id;
    }, get class() {
      return Ve([a.class, { "border-destructive text-destructive": a.field.state.meta.errors.length }]);
    } })), createComponent(Switch, { get children() {
      return [createComponent(Match, { get when() {
        return a.field.state.meta.errors;
      }, keyed: true, children: (s) => createComponent(For, { each: s, children: (r) => createComponent(Wc, { children: r }) }) }), createComponent(Match, { get when() {
        return a.helpMessage;
      }, get children() {
        return createComponent(Vc, { get children() {
          return a.helpMessage;
        } });
      } })];
    } })];
...
function k(i) {
  const n = mergeProps$1({ type: "text", class: "" }, i), [a, e, t] = splitProps(n, ["field", "children", "class", "helpMessage"], ["onChange"]);
  return createComponent(Nc, { get validationState() {
    return a.field.state.meta.errors.length ? "invalid" : "valid";
  }, get onChange() {
    return e.onChange;
    ...
    return [createComponent(jc, { get for() {
      ...
      return [a.children, createComponent(Show, { get when() {
        ...
        return ssr(Kt, ssrHydrationKey());
      } })];
    } }), createComponent(Bc, mergeProps(t, { get class() {
      return Ve([a.class, { "border-destructive text-destructive": a.field.state.meta.errors.length }]);
    }, get "aria-invalid"() {
      ...
      return [createComponent(Match, { get when() {
        ...
        return createComponent(For, { get each() {
          var _a2;
          return (_a2 = a.field.state.meta.errors) != null ? _a2 : [];
        }, children: (s) => createComponent(Wc, { children: s }) });
...
var Nt = ["<div", ' data-aos="fade-down"', '><h4 class="font-semibold text-lg">Obrigado!</h4><p>A sua mensagem foi enviada com sucesso, iremos responder o mais breve poss\xEDvel.</p></div>'], Rt = ["<form", ' class="space-y-6"><!--$-->', "<!--/--><!--$-->", "<!--/--><!--$-->", "<!--/--><!--$-->", "<!--/--><!--$-->", "<!--/--><!--$-->", "<!--/--></form>"];
function Qt() {
  const [i, n] = createSignal(false), a = x(Dt), e = Ut(() => ({ defaultValues: { name: "", email: "", phone: 0, message: "", acceptance: false }, onSubmit: async ({ value: t }) => {
    try {
      await a(t);
    } catch {
  ...
  return ssr(Rt, ssrHydrationKey(), escape(createComponent(Show, { get when() {
    return i();
  }, get children() {
    return ssr(Nt, ssrHydrationKey(), ssrAttribute("class", escape(Ve(["px-2 py-3", "rounded border border-green-500", "bg-green-50/20", "text-sm"]), true), false));
  } })), escape(createComponent(e.Field, { name: "name", get validators() {
    return { onSubmit: z$1.string({ required_error: "Por favor, preencha o seu nome." }).min(2, "Por favor, preencha o seu nome."), onChange: z$1.string({ required_error: "Por favor, preencha o seu nome." }).min(2, "Por favor, preencha o seu nome.") };
  }, children: (t) => createComponent(k, { type: "text", required: true, get id() {
    return t().name;
  }, get name() {
    return t().name;
  }, get onBlur() {
    return t().handleBlur;
  }, onChange: (s) => t().handleChange(s), get field() {
    return t();
  }, placeholder: "Por favor introduza o seu nome.", children: "Nome" }) })), escape(createComponent(e.Field, { name: "email", get validators() {
    return { onSubmit: z$1.string({ required_error: "Por favor, preencha o seu nome." }).email("Por favor, introduza um email v\xE1lido"), onChange: z$1.string({ required_error: "Por favor, preencha o seu nome." }).email("Por favor, introduza um email v\xE1lido") };
  }, children: (t) => createComponent(k, { required: true, get id() {
    return t().name;
  }, get name() {
    return t().name;
  }, type: "email", get onBlur() {
    return t().handleBlur;
  }, onChange: (s) => t().handleChange(s), get field() {
    return t();
  }, placeholder: "Por favor introduza o seu email.", children: "Email" }) })), escape(createComponent(e.Field, { name: "phone", get validators() {
    return { onChange: z$1.number({ invalid_type_error: "Por favor, introduza apenas n\xFAmeros." }).refine((t) => t ? /^\d{9}$/.test(String(t)) : true, "Por favor, introduza um contacto v\xE1lido.").optional(), onSubmit: z$1.number({ invalid_type_error: "Por favor, introduza apenas n\xFAmeros." }).refine((t) => t ? /^\d{9}$/.test(String(t)) : true, "Por favor, introduza um contacto v\xE1lido.").optional() };
  }, children: (t) => createComponent(k, { get id() {
    return t().name;
  }, get name() {
    return t().name;
  }, type: "number", get onBlur() {
    return t().handleBlur;
  }, onChange: (s) => t().handleChange(Number(s)), get field() {
    return t();
  }, pattern: "d{9}", placeholder: "Por favor introduza o seu contacto telef\xF3nico.", children: "Contacto telef\xF3nico" }) })), escape(createComponent(e.Field, { name: "message", get validators() {
    return { onChange: z$1.string({ required_error: "Por favor, preencha a mensagem." }).min(5, "A sua mensagem deve conter, pelo menos, 5 caracteres.") };
  }, children: (t) => createComponent(Gt, { get id() {
    return t().name;
  }, get name() {
    return t().name;
  }, get onBlur() {
    return t().handleBlur;
  }, required: true, onChange: (s) => t().handleChange(s), get field() {
    return t();
  }, placeholder: "Por favor introduza a sua mensagem.", children: "Mensagem" }) })), escape(createComponent(e.Subscribe, { selector: (t) => ({ canSubmit: t.canSubmit, isSubmitting: t.isSubmitting }), children: (t) => createComponent(Fc, { get disabled() {
    return !t().canSubmit || t().isSubmitting;
  }, get class() {
    return Ve(["w-fit", { "animate-pulse": t().isSubmitting }]);
  }, type: "submit", children: "Enviar" }) })));
}
var Wt = ["<section", ' class=""><div><!--$-->', "<!--/--><!--$-->", "<!--/--></div></section>"], Jt = ["<h2", ' class="font-semibold text-lg text-zinc-50 md:text-xl">', "</h2>"], Xt = ["<p", ' class="mt-2">', "</p>"];
function Yt(i) {
  return ssr(Wt, ssrHydrationKey(), escape(createComponent(Show, { get when() {
    return i.title;
  }, keyed: true, children: (n) => ssr(Jt, ssrHydrationKey(), escape(n)) })), escape(createComponent(Show, { get when() {
    return i.headline;
  }, keyed: true, children: (n) => ssr(Xt, ssrHydrationKey(), escape(n)) })));
}
var te = ["<main", '><header class="py-16"><div class="container flex flex-col items-center justify-center gap-2 text-center"><h1 class="font-bold">', "</h1><!--$-->", '<!--/--></div></header><section class="py-8 md:py-12"><div class="container grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-[0.5fr_1fr]"><!--$-->', "<!--/--><section><!--$-->", "<!--/--><!--$-->", "<!--/--><!--$-->", "<!--/--></section></div></section></main>"], ee = ["<p", ' class="text-lg">', "</p>"], se = ["<h2", ">", "</h2>"], ae = ["<p", ' class="mb-6">', "</p>"];
function Fe() {
  var _a2, _b2;
  const i = bc(() => Dc()), n = bc(() => Oc());
  return ssr(te, ssrHydrationKey(), (_b2 = escape((_a2 = i()) == null ? void 0 : _a2.title)) != null ? _b2 : "Contactos", escape(createComponent(Show, { get when() {
    var _a3;
    return (_a3 = i()) == null ? void 0 : _a3.headline;
  }, keyed: true, children: (a) => ssr(ee, ssrHydrationKey(), escape(a)) })), escape(createComponent(Show, { get when() {
    var _a3, _b3, _c2, _d2;
    return !!((_b3 = (_a3 = n()) == null ? void 0 : _a3.contacts) == null ? void 0 : _b3.length) || !!((_d2 = (_c2 = n()) == null ? void 0 : _c2.social) == null ? void 0 : _d2.length);
  }, get children() {
    return createComponent(Yt, { get title() {
      var _a3, _b3;
      return (_b3 = (_a3 = i()) == null ? void 0 : _a3.list) == null ? void 0 : _b3.title;
    }, get headline() {
      var _a3, _b3;
      return (_b3 = (_a3 = i()) == null ? void 0 : _a3.list) == null ? void 0 : _b3.headline;
    }, get contacts() {
      var _a3;
      return (_a3 = n()) == null ? void 0 : _a3.contacts;
    }, get social() {
      var _a3;
      return (_a3 = n()) == null ? void 0 : _a3.social;
    } });
  } })), escape(createComponent(Show, { get when() {
    var _a3, _b3;
    return (_b3 = (_a3 = i()) == null ? void 0 : _a3.form) == null ? void 0 : _b3.title;
  }, keyed: true, children: (a) => {
    var _a3, _b3;
    return ssr(se, ssrHydrationKey() + ssrAttribute("class", escape(Ve(["mb-1 font-semibold", { "mb-6": !((_b3 = (_a3 = i()) == null ? void 0 : _a3.form) == null ? void 0 : _b3.headline) }]), true), false), escape(a));
  } })), escape(createComponent(Show, { get when() {
    var _a3, _b3;
    return (_b3 = (_a3 = i()) == null ? void 0 : _a3.form) == null ? void 0 : _b3.headline;
  }, keyed: true, children: (a) => ssr(ae, ssrHydrationKey(), escape(a)) })), escape(createComponent(Qt, {})));
}

export { Fe as default };
//# sourceMappingURL=contactos2.mjs.map
