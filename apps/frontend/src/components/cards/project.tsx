  ...
  return (
    ...
    >
      ...
      >
        ...
        <section class="flex size-full flex-col justify-end bg-gradient-to-b from-transparent to-foreground/60 px-6 py-8 text-gray-50 transition-colors duration-300 ease-in-out group-hover:to-foreground">
          <h3 class="font-semibold text-white">{projectProps.title}</h3>

          <Show when={projectProps.headline}>
            <p class="mt-1 mb-4 line-clamp-3 text-sm">{projectProps.headline}</p>
          </Show>
